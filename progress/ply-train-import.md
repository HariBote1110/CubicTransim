...
## 検証結果(voxel=1.25、flip無し、露出面重み付け+彩度タイブレーク適用後)

- car_head(KUHA由来): 400三角形、AABB幅0.164×高さ0.205×全長0.860、帯色(オレンジ系)頂点120個
- car_mid(MOHA由来): 372三角形、AABB幅0.164×高さ0.205×全長0.860、帯色(オレンジ系)頂点78個
- `validate_train_glb.mjs` 総合判定: PASS(全項目)
- 出力ファイルサイズ: 約33KB(コミット対象)
